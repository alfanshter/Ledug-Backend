...
@section('konten')
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Bayar/Beli</h1>
                    @if (auth()->user()->role ==0)
                    <button class="btn btn-primary"  data-toggle="modal" data-target="#tambahsiswa">Tambah bayar/beli</button>                        
                    @endif
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Tambah bayarbeli?</h5>
                                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">×</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <form action="/bayarbeli" method="POST" enctype="multipart/form-data">
                                            @csrf
                    ...
                    <div class="card shadow mb-4 mt-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Data bayarbeli</h6>
                        </div>
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <div class="d-flex justify-content-sm-center mt-2">
                                                    ...
                                                    <form action="/bayarbeli/delete" method="post">
                                                        @csrf
                                                    ...
                                                    <a href="/bayarbeli/{{$data->id}}" class="btn btn-warning ml-2">Edit</a>
                                                </div>
                                                </td>                                        
